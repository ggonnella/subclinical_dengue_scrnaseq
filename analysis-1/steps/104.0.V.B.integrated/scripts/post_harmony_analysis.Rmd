---
title: "InDen B cells | Results after Harmony integration"
...
this_step_dir <- paste0(analysis_root, "steps/104.0.V.B.integrated/")
...
DimPlot(object = so, reduction = "umapharm", group.by = "Phase",
        split.by = "clinical_condition", cols = so@misc$phase_cols) +
...
fname <- paste0(plots_outdir, "umap.celltypes.svg")
