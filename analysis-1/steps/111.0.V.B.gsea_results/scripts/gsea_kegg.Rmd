---
title: "InDen B cells | Gene Sets Expression Analysis Results | KEGG"
...
prev_step_dir <- paste0(analysis_root, "steps/111.0.P.B.gsea_analysis/")
input_var_dir <- paste0(prev_step_dir, "results/vars/")
if (!dir.exists(input_var_dir)) {
  stop("Input variable directory does not exist: ", input_var_dir)
}

this_step_dir <- paste0(analysis_root, "steps/111.0.V.B.gsea_results/")
