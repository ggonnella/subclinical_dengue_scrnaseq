...
encode_input <- paste0(prj_root, "data/bcr_vdj_output")
...
# assertions: all barcodes are unique
...
```{r gene_groups}
vgm[["VDJ"]]$VJ_vgene_grp <- sub("-.*", "", vgm[["VDJ"]]$VJ_vgene)
vgm[["VDJ"]]$VJ_vgene_grp <- sub("/.*", "", vgm[["VDJ"]]$VJ_vgene_grp)
vgm[["VDJ"]]$VDJ_vgene_grp <- sub("-.*", "", vgm[["VDJ"]]$VDJ_vgene)
