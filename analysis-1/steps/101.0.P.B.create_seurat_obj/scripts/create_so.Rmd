---
title: "InDen B cells | Individual samples | First steps"
...
data_dir <- paste0(prj_root, "cellranger/results/")
...
this_step_dir <- paste0(analysis_root, "steps/101.0.P.B.create_seurat_obj/")
...
```{r CD8_positivity}
so$CD8_plus <- so@assays$RNA$counts["CD8A",] > 0 |
               so@assays$RNA$counts["CD8B",] > 0
```
