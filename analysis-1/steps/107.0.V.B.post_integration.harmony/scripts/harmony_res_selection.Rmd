---
title: "InDen Project | T cells | Clustering resolutions comparison after integration"
...
so@misc$sample_cols <- colorRampPalette(brewer.pal(8, name = "Accent"))(
...
cl_cols <- colorRampPalette(brewer.pal(9, name = "Set1"))(24)
for(g.b in grep("^harmsnn_res", colnames(so@meta.data), value = TRUE)){
...
for(g.b in grep("^harmsnn_res", colnames(so@meta.data),
                value = TRUE)){
