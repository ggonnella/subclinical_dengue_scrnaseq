...
#load(file = paste0(input_var_dir, "TC_SC03_alltcells.Rdata"))
...
plt <- grouped_combined_permutation_test_plot(so, prop_test,
            "pruned.labels_singleR_fine.mod.abbrev", "cell_group", "clinical_condition",
            "Clinical Condition", so@misc$cond_cols, so@misc$ctg_backcols)
