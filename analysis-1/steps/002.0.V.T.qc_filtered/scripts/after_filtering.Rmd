...
input_step_dir <- paste0(analysis_root, "steps/002.0.P.T.qc_filter/")
input_var_dir <- paste0(input_step_dir, "results/vars/")
if (!dir.exists(input_var_dir)) {
  stop("Input variable directory does not exist: ", input_var_dir)
}

this_step_dir <- paste0(analysis_root, "steps/002.0.V.T.qc_filtered/")
...
print(paste0("nCells failing CD3 filter: ",
              so@misc$qc_filtering$nCells_failing_CD3))
