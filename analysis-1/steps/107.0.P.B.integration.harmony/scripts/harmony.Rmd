---
title: "InDen Project | B cells | Harmony Integration"
...
prev_step_dir <- paste0(analysis_root, "steps/106.0.P.B.merging.seurat/")
...
#SC_gal_tools_dir <- paste0(this_step_dir, "scripts/smella_scripts/")
...
so <- readRDS(file = paste0(input_var_dir, "merged_so.rds"))
