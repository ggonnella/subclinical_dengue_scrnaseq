#!/bin/bash
cd 101.0.P.B.create_seurat_obj/rundir && ./run_all_samples.sh && cd -
cd 102.0.P.B.qc_filter/rundir/ && ./run_all_samples.sh && cd -
knit2html 103.0.P.B.merging.seurat/rundir/merging.Rmd
knit2html 103.0.V.B.merged/rundir/post_merging.Rmd &
knit2html 104.0.P.B.integration.harmony/rundir/harmony.Rmd
knit2html 104.0.P.B.integration.harmony/rundir/harmony_post_processing.Rmd
