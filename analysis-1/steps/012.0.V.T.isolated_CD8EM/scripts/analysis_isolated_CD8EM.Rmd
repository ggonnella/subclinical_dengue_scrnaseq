---
title: "InDen Project | T cells | Isolate Effector Memory CD8+ cells"
...
input_step_dir <- paste0(analysis_root, "steps/012.0.P.T.isolate_CD8EM/")
input_var_dir <- paste0(input_step_dir, "results/vars/")

this_step_dir <- paste0(analysis_root, "steps/012.0.V.T.isolated_CD8EM/")
...
```{r}
prop_test <- EM_cells@misc$prop_test
```
